...
#'
#' @param from_date A character string specifying the start date of the \code{Interval} vector in the format "%m-%d-%Y". Defaults to '01-01-2011'
#' @param to_date A character string specifying the stop date of the \code{Interval} vector in the format "%m-%d-%Y". Defaults to '01-01-2111'.
...
#'
#' @return A vector of \code{Interval} objects.
#'
